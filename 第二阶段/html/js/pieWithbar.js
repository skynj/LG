        	...
        	var option_my2 = {
                tooltip: {
                    ...
                    formatter: function (params,ticket,callback) {
                        ...
                        var res =  '<div style="border:1px solid #254065;margin:-4px;position:relative;"><p style="font-size:15px;color:#ffffff;padding:10px 14px;border-bottom:1px solid #000;">' + params[0][1] +'</p>';
