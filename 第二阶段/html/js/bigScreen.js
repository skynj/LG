...
function barWithBroken() {
    ...
    require(
        ...
        function (ec) {
            var myChart1 = ec.init(document.getElementById('charts-1'));
            var myChart2 = ec.init(document.getElementsByClassName('charts-2')[0]);
            var myChart3 = ec.init(document.getElementById('charts-2-1'));
            var myChart4 = ec.init(document.getElementsByClassName('charts-4')[0]);
            var myChart5 = ec.init(document.getElementsByClassName('charts-5')[0]);
            var myChart6 = ec.init(document.getElementsByClassName('charts-6')[0]);
                                ...
                                areaStyle: {
                                    ...
                                    color: (function () {
                                        ...
                                        return zrColor.getLinearGradient(
                                            0, 250, 0, 5000,
                                            [[0, 'rgba(1,92,163,0.5)'], [0.5, 'rgba(9,79,141,0.5)'], [1, 'rgba(255,255,255,0)']]        //rgba(59,229,118,0.1)
                                        )
                                    })()
                                }
                            }
            ...
            var option_my6 = {
                tooltip: {
                    ...
                    formatter: function (params, ticket, callback) {
                        ...
                        var res = '';
                        res += '<p style="color:#ffffff;font-size:15px;">' + params[0] + '</p>';
                        res += '<p><label style="color:#009cff;">能耗总量</label>' + '<label style="color:#00ffea;padding-left:15px;font-size:24px;">' + params[2][0] + '<span style="padding-left:5px;font-size:12px;color:#009cff;">吨标煤</span></label></p>';
                        res += '<p><label style="color:#009cff;">碳排总量</label>' + '<label style="color:#00ffea;padding-left:15px;font-size:24px;">' + params[2][1] + '<span style="padding-left:5px;font-size:12px;color:#009cff;">吨CO2e</span></label></p>';
                        res += '<p><label style="color:#009cff;">碳排放强度</label>' + '<label style="color:#00ffea;padding-left:15px;font-size:24px;">' + params[2][3] + '<span style="padding-left:5px;font-size:12px;color:#009cff;">吨CO2e/吨标煤</span></label></p>';
                        return res;
                    }
                },
                legend:
